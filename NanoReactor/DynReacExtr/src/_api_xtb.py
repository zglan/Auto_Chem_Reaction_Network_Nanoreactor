...
class Xtb_Set:
    ...
    def runXTB(self):
        ...
        if self.jobType == 'sp':
            ...
            os.system('xtb %s --input %s --opt > %s' % (self.xyz, self.inp, self.log))
    ...
    def getOptStruct(self):
        optXyz = 'xtbopt.xyz'
        r_optXyz = str(self.xyz).split('.')[0] + '-opt.xyz'
        self.runXTB()
        os.rename(optXyz, r_optXyz)
        return r_optXyz
